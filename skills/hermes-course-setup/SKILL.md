...
This skill guides the Agent to set up a new programming course generation workspace. It handles
requirements gathering, directory structure creation, and initial configuration.
...
1. **`overview.md`**: Summarizes course goals, learner outcomes, and specific targets for each
   level.
...
Present the final workspace structure and the generated syllabus (`architecture.md`) to the user.
Guide them to trigger the next phase using the `hermes-course-writer` skill.
